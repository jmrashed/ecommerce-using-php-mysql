<div id="sidebar-left" class="span2">
    <div class="nav-collapse sidebar-nav">
        <ul class="nav nav-tabs nav-stacked main-menu">
            ...
            <li><a href="add_product.php"><i class="icon-edit"></i><span class="hidden-tablet"> Add Books</span></a></li>
            <li><a href="manage_product.php"><i class="icon-list-alt"></i><span class="hidden-tablet"> Manage Books</span></a></li>
