...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 16, 2017 at 06:38 PM
...
(26, 't', 't', 'test4@admin.com', '21232f297a57a5a743894a0e4a801fc3', '3443', '1', '444', 'Dhaka', 'Dhaja', 1),
(27, 'test33', 'test33', 'test33@gmail.com', '9cb45d54b2ccdc1c486e2f3eb87fbe9f', '32435', '1', 'test33', 'test33', 'test33', 1),
(28, 'testtt', 'testtt', 'testtt@gmail.com', 'f55e23f49445a3cf708c19577f218a5b', '3435', '1', 'testtt', 'testtt', 'testtt', 1);
...
INSERT INTO `tbl_feedback` (`id`, `name`, `email`, `feedback`, `sender_id`, `admin_id`, `type`, `is_read`, `datetime`) VALUES
(0, 'test 111', 'admin@admin.com', 'etst 111', 2, 0, 'tbl_customer', 0, '2017-01-04 23:09:51');
...
(5, 26, 5, 0.00, 'pending', '2017-01-03 16:50:35'),
(6, 27, 6, 0.00, 'pending', '2017-01-04 15:26:41'),
(7, 28, 7, 0.00, 'pending', '2017-01-04 15:34:48');
...
(5, 5, 'cash_on_delivery', 'pending', '2017-01-03 16:50:35'),
(6, 6, 'cash_on_delivery', 'pending', '2017-01-04 15:26:41'),
(7, 7, 'cash_on_delivery', 'pending', '2017-01-04 15:34:48');
...
(7, 'test', 7, 0, 0.00, 33, '', 'test', '', '../assets/product_images/22.jpg', 1),
(8, '', 0, 0, 0.00, 0, '', '', '', '', 0),
(9, 'Clock', 4, 3, 250.00, 10, '5', 'Clock&nbsp;<span style="color: rgb(51, 51, 51); font-family: &quot;Open Sans&quot;, sans-serif; font-size: 14px; text-align: right; background-color: rgb(255, 255, 255);">Short Description</span>', '<ol><li style="font-family: Arial, Verdana; font-size: 10pt; font-style: normal; font-variant-ligatures: normal; font-variant-caps: normal; font-weight: normal;">Clock&nbsp;<span style="color: rgb(51, 51, 51); font-family: &quot;Open Sans&quot;, sans-serif; font-size: 14px; text-align: right; background-color: rgb(255, 255, 255);">long Description</span></li><li style="font-family: Arial, Verdana; font-size: 10pt; font-style: normal; font-variant-ligatures: normal; font-variant-caps: normal; font-weight: normal;">Clock&nbsp;<span style="color: rgb(51, 51, 51); font-family: &quot;Open Sans&quot;, sans-serif; font-size: 14px; text-align: right; background-color: rgb(255, 255, 255);">long Description</span></li></ol><div><font color="#333333" face="Open Sans, sans-serif"><span style="font-size: 14px;"><br></span></font></div><ol><li>Clock&nbsp;<span style="color: rgb(51, 51, 51); font-family: &quot;Open Sans&quot;, sans-serif; font-size: 14px; text-align: right; background-color: rgb(255, 255, 255);">long Description</span></li><li>Clock&nbsp;<span style="color: rgb(51, 51, 51); font-family: &quot;Open Sans&quot;, sans-serif; font-size: 14px; text-align: right; background-color: rgb(255, 255, 255);">long Description</span></li></ol><div><font color="#333333" face="Open Sans, sans-serif"><span style="font-size: 14px;"><br></span></font></div><ol><li>Clock&nbsp;<span style="color: rgb(51, 51, 51); font-family: &quot;Open Sans&quot;, sans-serif; font-size: 14px; text-align: right; background-color: rgb(255, 255, 255);">long Description</span></li><li>Clock&nbsp;<span style="color: rgb(51, 51, 51); font-family: &quot;Open Sans&quot;, sans-serif; font-size: 14px; text-align: right; background-color: rgb(255, 255, 255);">long Description</span></li><li>Clock&nbsp;<span style="color: rgb(51, 51, 51); font-family: &quot;Open Sans&quot;, sans-serif; font-size: 14px; text-align: right; background-color: rgb(255, 255, 255);">long Description</span></li></ol>', '../assets/product_images/clock.jpg', 1),
(10, 'cute kids clothes', 5, 3, 550.00, 11, '11', '<span style="color: rgb(84, 84, 84); font-family: arial, sans-serif; font-size: small; background-color: rgb(255, 255, 255);">Shop online for&nbsp;</span><span style="font-weight: bold; color: rgb(106, 106, 106); font-family: arial, sans-serif; font-size: small; background-color: rgb(255, 255, 255);">cute kids clothes</span><span style="color: rgb(84, 84, 84); font-family: arial, sans-serif; font-size: small; background-color: rgb(255, 255, 255);">&nbsp;and shoes with FabKids. FabKids delivers high quality, ready-to-play boys and girls clothing &amp; shoes every month!</span>', '<span style="color: rgb(84, 84, 84); font-family: arial, sans-serif; font-size: small; background-color: rgb(255, 255, 255);">Shop online for&nbsp;</span><span style="font-weight: bold; color: rgb(106, 106, 106); font-family: arial, sans-serif; font-size: small; background-color: rgb(255, 255, 255);">cute kids clothes</span><span style="color: rgb(84, 84, 84); font-family: arial, sans-serif; font-size: small; background-color: rgb(255, 255, 255);">&nbsp;and shoes with FabKids. FabKids delivers high quality, ready-to-play boys and girls clothing &amp; shoes every month!</span>', '../assets/product_images/cute-kids-clothes-03.jpg', 1);
...
INSERT INTO `tbl_review` (`id`, `product_id`, `name`, `email`, `message`, `datetime`) VALUES
(1, 9, 'Masum', 'masum@gmail.com', 'I have bought a clock.\r\nThis product is very good.', '2017-01-04 14:30:29'),
(2, 9, 'Dr. Masum', 'dr@gmail.com', 'I have bought a pen.\r\nThis product is very good.', '2017-01-04 14:30:29'),
(3, 7, 'minhaz', 'minhaz@yahoo.com', 'Thanks', '2017-01-02 08:17:29'),
(4, 9, 'Dr. Abdullah Al-Amin', 'admin@admin.com', 'test', '2017-01-04 00:20:32'),
(5, 9, 'Dr. Abdullah Al-Amin', 'admin@admin.com', 'product_details.php', '2017-01-04 00:21:08'),
(6, 3, 'Dr. Abdullah Al-Amin', 'admin@admin.com', 'nice product', '2017-01-04 00:23:06'),
(7, 3, 'Dr. Abdullah Al-Amin', 'admin@admin.com', 'nice product', '2017-01-04 00:23:06'),
(8, 1, 'Md Rasheduzzaman', 'jmrashed@gmail.com', 'tstst', '2017-01-04 00:24:11'),
(9, 1, 'Md Rasheduzzaman', 'jmrashed@gmail.com', 'tstst', '2017-01-04 00:24:11'),
(10, 1, 'Md Rasheduzzaman 34', 'jmrashed@gmail.com', 'tstst', '2017-01-04 00:24:41'),
(11, 1, 'Md Rasheduzzaman 34', 'jmrashed@gmail.com', 'tstst', '2017-01-04 00:24:41'),
(12, 2, 'Abdullah Shaheen', 'xadmin@live.com', 'WEll description. WEll description.WEll description.WEll description.WEll description.WEll description.WEll description.WEll description. WEll description.WEll description.WEll description.WEll description.WEll description.WEll description.\r\n\r\n', '2017-01-04 00:25:56'),
(13, 2, 'Abdullah Shaheen', 'xadmin@live.com', 'WEll description. WEll description.WEll description.WEll description.WEll description.WEll description.WEll description.WEll description. WEll description.WEll description.WEll description.WEll description.WEll description.WEll description.\r\n\r\n', '2017-01-04 00:25:56'),
(14, 0, 'test', 'student1@demo.com', 'test', '2017-01-04 00:26:29'),
(15, 0, 'test', 'student1@demo.com', 'test', '2017-01-04 00:26:29'),
(16, 9, 'Md Rasheduzzaman', 'jmrashed@gmail.com', 'sadadddddddddWEll description. WEll description.WEll description.WEll description.WEll description.WEll description.WEll description.WEll description. WEll description.WEll description.WEll description.WEll description.WEll description.WEll description.\r\n\r\n', '2017-01-04 00:26:47'),
(17, 9, 'Md Rasheduzzaman', 'jmrashed@gmail.com', 'sadadddddddddWEll description. WEll description.WEll description.WEll description.WEll description.WEll description.WEll description.WEll description. WEll description.WEll description.WEll description.WEll description.WEll description.WEll description.\r\n\r\n', '2017-01-04 00:26:48');
...
(5, 't t', 'test4@admin.com', '3443', '444', 'Dhaka', 'Dhaja'),
(6, 'test33 test33', 'test33@gmail.com', '32435', 'test33', 'test33', 'test33'),
(7, 'testtt testtt', 'testtt@gmail.com', '3435', 'testtt', 'testtt', 'testtt');
...
(17, 'bq7ido6763dqvkl0snbrepikr0', 9, 'Clock', 250.00, 2, '../assets/product_images/clock.jpg');
